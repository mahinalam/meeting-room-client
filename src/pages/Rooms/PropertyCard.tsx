...
// const PropertyCard = () => {
//   return (
//     <div className="flex p-4 border-2  justify-between">
//       {/* image section */}
//       <section>
...
//             </p>
//             <span className="flex items-center bg-[#006CE4] text-white p-2 mt-6">
...
const PropertyCard = () => {
  return (
    <div className="flex p-4 border-2  justify-between gap-4">
      {/* image section */}
      <section>
        <div className="w-full">
          <img
      ...
      <div className="flex justify-between w-full">
        ...
        <section className="flex flex-col items-end">
          ...
          {/*     avalinblity button */}
          <div className="pt-5">
            <span className="flex items-center bg-[#006CE4] text-white p-2 gap-2 rounded-md">
              <button>See availability</button>
              <span>
                {" "}
                <svg
